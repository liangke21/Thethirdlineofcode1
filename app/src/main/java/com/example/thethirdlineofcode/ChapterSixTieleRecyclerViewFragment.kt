...
class ChapterSixTieleRecyclerViewFragment:Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val adapter=TitlerecyclerviewAdapter(ArrListtitleweb.ChapterSix)
    ...
    inner class TitlerecyclerviewAdapter(val TitleList:List<TitleWeb>): RecyclerView.Adapter<TitlerecyclerviewAdapter.ViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val view=
                LayoutInflater.from(parent.context).inflate(R.layout.acrtcle_title,parent,false)
